...
def recomendacion_por_juego(item_id):
    df = pd.read_csv('Recomendacion_por_Juego.csv')
    ...
    return response_data.head()

# ### ML

# ### Recomendación de juegos por usuario

def recomendacion_por_usuario(id_usuario):
    
    return "Función no terminada"
